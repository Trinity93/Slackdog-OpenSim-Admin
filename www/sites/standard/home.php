...
// Adding additional to the list

$DbLink->query("SELECT count(*) FROM ".C_ASSETS_TBL."");
list($TOTALASSETS) = $DbLink->next_record();
            ...
            width="1" /></div>
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                  ...
                  width="1%"><span class="txtcolor">
                      ...
                      <tr bgcolor="#000000">
                        <td style="PADDING-RIGHT: 3px; PADDING-LEFT: 3px; PADDING-BOTTOM: 2px; PADDING-TOP: 2px" valign="top" nowrap="nowrap" align="left"><span class="txtcolor">Total Assets:</span></td>
                        <td style="PADDING-RIGHT: 3px; PADDING-LEFT: 3px; PADDING-BOTTOM: 2px; PADDING-TOP: 2px" valign="top" nowrap="nowrap" align="right" 
                  width="1%"><span class="txtcolor">
                          <?=$TOTALASSETS?>
                        </span></td>
