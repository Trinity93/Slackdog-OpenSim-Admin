      ...
      <br />
        ...
        <tbody>
          ...
          <tr>
			...
			for($i=31; $i>=0; $i--)
			{
			$datestart= date("d/m/Y",$starttime);
...
<TABLE width="90%" 
  ...
  <TBODY>
        <TR bgColor=#eeeeee>
          ...
          <TD width="7%"><span style="font-size: 12px"><B style="COLOR: #000000">Date</B></span></TD>
          <TD width="7%"><span style="font-size: 12px"><B style="COLOR: #000000">Time</B></span></TD>
          ...
          <TD align=right width="24%"><span style="font-size: 12px"><B style="COLOR: #000000">Balance</B></span></TD></TR>
<?
...
?>
        <TR bgColor=#ffffff>
          ...
          <? if ($description == "Give Inventory")
			 {
					echo"L$ 0";
			 }
			 else if($amount < 0){echo"L$ $amount";} ?></span></TD>
