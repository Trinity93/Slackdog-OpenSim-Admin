...
if($_POST[state]=="set"){
$DbLink->query("SELECT ".C_USERS_TBL.".PrincipalID,".C_USERS_TBL.".FirstName,".C_USERS_TBL.".LastName,".C_AUTH_TBL.".passwordHash,".C_USERS_TBL.".Created FROM ".C_USERS_TBL.", ".C_AUTH_TBL." WHERE ".C_USERS_TBL.".PrincipalID=".C_AUTH_TBL.".UUID  AND ".C_USERS_TBL.".PrincipalID='$_POST[uuid]'");
