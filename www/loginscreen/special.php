      ...
      <TABLE width=100% height="100" border=0 cellPadding=0 cellSpacing=0>
        ...
        <TR>
          ...
          <TD class=black_content>
			...
			<CENTER>
			At this moment we would like to ask you<br>to go to the website and make<br>sure that you have your correct email registered<p>
			Visit <a target = _new href = http://www.slackdog.com/>the website</a> for more information
			</center>
			 </DIV>
		  </TD>
